...
const cinemaUpgrade = String.raw`
        function mountSwiflyCinemaSettings(media) {
          ...
          if (!document.getElementById("swiflyCinemaSettingsStyle")) {
            ...
            style.textContent = [
              "body.swifly-command-settings .swiflyUiBottom{overflow:visible;display:flex;flex-direction:column;padding:25px 9px 7px;transition:padding .22s cubic-bezier(.22,1,.36,1),border-color .2s ease,box-shadow .22s ease,background .22s ease}",
              ...
              "body.swifly-command-settings .swiflyUiMenu{display:block!important;position:relative!important;inset:auto!important;align-self:flex-end!important;width:min(540px,calc(100% - 64px))!important;min-width:0!important;max-width:none!important;max-height:0!important;margin:0 44px 0 auto!important;padding:0!important;border:0!important;border-radius:0!important;overflow:visible!important;visibility:hidden!important;opacity:0!important;background:transparent!important;box-shadow:none!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important;transform:translateY(6px) scale(.992)!important;transform-origin:right bottom!important;pointer-events:none!important;transition:max-height .22s cubic-bezier(.22,1,.36,1),margin .22s cubic-bezier(.22,1,.36,1),opacity .13s ease,transform .22s cubic-bezier(.22,1,.36,1),visibility 0s linear .22s!important}",
              "body.swifly-command-settings .swiflyUiMenu:not([hidden]){max-height:42px!important;margin-bottom:3px!important;visibility:visible!important;opacity:1!important;transform:none!important;pointer-events:auto!important;transition-delay:0s!important}",
              "body.swifly-command-settings .swiflyNativeSettings{display:none!important}",
              "body.swifly-command-settings .swiflySettingsShell{width:100%!important;min-height:0!important;max-width:none!important}",
              "body.swifly-command-settings .swiflySettingsHome,body.swifly-command-settings .swiflySettingsDetail{width:100%!important;padding:0!important;max-width:none!important}",
              ...
              "body.swifly-command-settings .swiflySettingsHome:not([hidden]){display:block!important;animation:swiflyCommandHomeIn .18s cubic-bezier(.22,1,.36,1) both}",
              "body.swifly-command-settings .swiflySettingsDetail:not([hidden]){display:flex!important;animation:swiflyCommandDetailIn .18s cubic-bezier(.22,1,.36,1) both}",
              ...
              "body.swifly-command-settings .swiflySettingsList{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;width:100%!important;min-width:0!important;max-width:none!important;align-items:center!important;gap:2px!important;margin:0!important;padding:3px!important;border:1px solid rgba(255,255,255,.075)!important;border-radius:12px!important;overflow:visible!important;background:linear-gradient(180deg,rgba(22,23,36,.62),rgba(7,8,15,.67))!important;box-shadow:0 10px 28px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.045)!important;-webkit-backdrop-filter:blur(20px) saturate(1.2)!important;backdrop-filter:blur(20px) saturate(1.2)!important}",
              "body.swifly-command-settings .swiflySettingRow{width:100%!important;min-width:0!important;max-width:none!important;min-height:32px!important;padding:0 8px!important;border:0!important;border-radius:9px!important;background:transparent!important;box-shadow:none!important;display:grid!important;grid-template-columns:15px minmax(0,1fr) auto!important;align-items:center!important;gap:5px!important;color:#fff!important;text-align:left!important;opacity:0;transform:translateY(4px);animation:swiflyCommandItemIn .18s cubic-bezier(.22,1,.36,1) forwards;transition:background .13s ease,color .13s ease,transform .13s ease,opacity .13s ease!important}",
              ...
              "body.swifly-command-settings .swiflySettingRow.isDisabled{display:grid!important;opacity:.46!important;cursor:not-allowed!important;filter:saturate(.45)!important}",
              "body.swifly-command-settings .swiflySettingRow.isDisabled:hover{background:transparent!important;transform:none!important}",
              "body.swifly-command-settings .swiflySettingIcon{width:15px!important;height:15px!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;color:rgba(224,216,255,.72)!important;font-size:7.75px!important}",
              "body.swifly-command-settings .swiflySettingCopy{min-width:0!important}",
              "body.swifly-command-settings .swiflySettingCopy strong{display:block!important;color:rgba(255,255,255,.91)!important;font-size:9.25px!important;font-weight:720!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}",
              ...
              "body.swifly-command-settings .swiflySettingValue{max-width:62px!important;padding:3px 6px!important;border:1px solid rgba(255,255,255,.045)!important;border-radius:999px!important;background:rgba(255,255,255,.025)!important;color:rgba(255,255,255,.62)!important;font-size:7.9px!important;font-weight:680!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}",
              "body.swifly-command-settings .swiflySettingMeta>i{display:none!important}",
              "body.swifly-command-settings .swiflySettingsDetail{width:100%!important;max-width:none!important;align-items:center!important;justify-content:flex-end!important;gap:3px!important;padding:3px!important;border:1px solid rgba(255,255,255,.075)!important;border-radius:12px!important;background:linear-gradient(180deg,rgba(22,23,36,.62),rgba(7,8,15,.67))!important;box-shadow:0 10px 28px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.045)!important;-webkit-backdrop-filter:blur(20px) saturate(1.2)!important;backdrop-filter:blur(20px) saturate(1.2)!important;overflow:hidden!important}",
              ...
              "body.swifly-command-settings .swiflyPlayerUi.menuOpen [data-a=settings] i{transform:rotate(90deg)!important;transition:transform .24s cubic-bezier(.22,1,.36,1)!important}",
              ...
              "@media(max-width:760px){body.swifly-command-settings .swiflyUiMenu{align-self:stretch!important;width:100%!important;max-width:100%!important;margin-right:0!important}body.swifly-command-settings .swiflySettingsList{display:flex!important;width:100%!important;justify-content:flex-start!important;overflow-x:auto!important;overflow-y:hidden!important;scrollbar-width:none!important}body.swifly-command-settings .swiflySettingsList::-webkit-scrollbar{display:none!important}body.swifly-command-settings .swiflySettingRow{flex:0 0 130px!important;width:130px!important;min-width:130px!important}body.swifly-command-settings .swiflySettingsDetail{width:100%!important;justify-content:flex-start!important}body.swifly-command-settings .swiflySettingsChoices{justify-content:flex-start!important}}",
          ...
          console.log("[swifly-cinema-settings] Four-column playback tray mounted without clipping.");
        }
...
fs.readFileSync = function swiflyCinemaSettingsRead(filePath, ...args) {
  ...
  console.log("[swifly-cinema-settings] Four-column settings tray injected into the working Aurora control deck.");
